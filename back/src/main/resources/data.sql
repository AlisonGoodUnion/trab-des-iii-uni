insert into usuario (id, nome, cpf, data_nascimento, habilitado, email, celular)
 values (1, 'Henrique Mentz', '031.904.620-62',  '1996-10-17', '1', 'henrique-mentz@hotmail.com', '51999203018');
